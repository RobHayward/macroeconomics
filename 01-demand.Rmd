...
## Aggregate demand
This chapter builds the model of aggregate demand. Aggregate demand is made up of household or consumer spending, business investment, government spending and net exports.  It is about the spending decisions of households, firms and government. These decisions are complex but we will try to simplify by using models.  The models will attempt to capture the *essence* or most important features of the process.  These decisions involve static and inter-temporal choice. That means making decisions about spending and saving now based on current conditions and expectations about the future.  Government policy can influence aggregate demand: interest rates can affect spending decisions of households and investment decisions of firms; taxation can change incentives and government spending directly influences demand. People in other countries influence overall demand with purchase and production of goods and services. Figure 1.0 show the evolution of the components of UK demand over time. 

![GDP Components [@carlinsoskice]](./Figures/Demand/components.jpg)

The relative importance of these components can change over time and can change between countries.  Household spending or consumption is always the most important element of GDP.  However, while consumption makes up 70% of GDP in the US, it is only 43% of the Chinese economy. An exceptionally high proportion of GDP in China comes from investment spending. This is a result of China's drive to increase the amount and quality of capital in the economy.  

The national accounts can be determined in three ways.  This is an **identity**, meaning that it must be the same by definition, and shown by 

1. Expenditure: all the spending in the economy

$$y \equiv C + I + G + (X - M)$$

There are tricky decisions about which category some things should put into.  Purchase of a new house would fall into investment. Government transfers (benefits, pensions etc) are recorded as consumption when spent. 
...
As you can see from Figure 1.0, Investment is much more volatile than consumption or government spending. Investment is pro-cyclical. That means that it does well when the economy is doing well and does badly when the economy is weak. Business investment is therefore a key driver of the business cycle. As the fluctuation becomes more extreme we get what is called **a recession**. In the US, the NBER makes the official definition of recessions.  There is a popular notion that a recession is defined as two quarters of negative growth.  However, not all recessions have negative growth so it is more of a *rule of thumb* than a strict rule.
...
The Great Moderation proceeded the **Global Financial Crisis (GFC)**.  We will discuss in the future how these two events may have been related. 

There are of course many questions raised about the use of GDP as a measure of welfare.  

 
## The three-equation model
Aggregate demand is the first part of the three-equation model that is presented by [@carlinsoskice]. The model represents the three key elements of the complex macro world. The first represents demand, the second supply and the third policy and the Phillips Curve.  Aggregate demand is represented by the IS curve and refers to the combination of planned investment and savings decisions that are consistent with equilibrium in the market for goods and services. Models are important for providing a framework for thinking about complex problems. The IS framework summarises the way that changes in spending decisions of households, firms and government multiply through the economy with their effect on output, spending and income. In response to an initial increase in spending, output will rise until the amount that households want to save is equal to the investment intentions of firms.  

![The Keynesian Cross [@carlinsoskice]](./Figures/Demand/Kcross.jpg)

Figure 1.3 shows the **Keynesian Cross**. This is the source of the IS curve.  The 45 degree line represents equilibrium as it is where output is equal to planned spending.  If spending and output are not equal, there is either excess demand or demand is too low.  In either of these cases firms will take action to return output to the level of planned spending by increasing or decreasing the amount that they produce.  If demand is too low, as it has been during the outbreak of Corvid-19, firms will cut output by curtailing overtime and hours worked or even making people redundant.  This has secondary effects as people with lower income now spend less.  The economy circulates downwards until output and demand are equal again. 

Insert some Keynesian Crost
 Exercises here. Maybe the shiny app. 

The level of aggregate demand is affected by current income and expectations about the future, credit constraints, interest rates and many other factors. Expectations about the future are important for household spending and for business investment.  Households will consider their future income, firms will try to assess the demand for their product.  Households and firms form expectations in the face of uncertainty. They are not sure what their income will be or the level of demand for their product.  There are also credit constraints because banks have difficulties in assessing the credit quality of firms and households. This means that borrowing by households and small business is often restricted. This makes it difficult for households and firms to borrow, even if they are very sure about their future income. Credit constraints are felt particularly by those without collateral. 

The IS curve shows the relationship between interest rates and aggregate demand.  It is downward sloping, suggesting that lower interest rates lead to higher aggregate demand.  This is somewhat controversial.  Interest rates are believed to affect household spending (through mortgage, house purchase and the purchase of furnishings as well as making savings more attractive.  Interest rates also affect the feasibility of investment project for firms. Lower interest rates make it cheaper to borrow and (for those with some knowledge of finance) increase the value of future projects by discounting the future at a lower rate. 
...
The IS curve will be built on the basis of consumption demand, investment demand and demand from government purchase. For now we have a **closed economy** with no traded with the rest of the world. 
...
<!-- The paradox of thrift says that saving in a recession will not be beneficial overall. It is possible to model the effect of a proposal to encourage savings during a recession by reducing $c_0$ to $c_0^'$.  Aggregate demand will fall by the difference between the two and the multiplier process will work in a downward direction. Indeed, the attempt to increase savings will not be successful.   -->
...
## The IS curve 
The IS curve is used to represent the demand side of the economy. Lower interest rates encourage more demand.  This is controversial because expectations are very important for business investment.  In an environment where the economy is in recession, pessimistic expectations may be much more important than the level of interest rates.   If business cannot currently sell their product and don't expect to be able to in the future, low interest rates are not likely to encourage investment. 

It is assumed that aggregate demand is influenced by the real interest rate. 
...
Expectations are important.  There is an intertemporal element to household spending and business investment. Households will adjust their spending to expected future income. Business make investment decisions based on expectations about future demand for products and input costs. For example, expectations about future Chinese demand will be important. Borrowing against future income is called *consumption smoothing*. People would like to smooth their consumption over time.  

You can return to the [CORE Textbook](https://core-econ.org/the-economy/book/text/10.html#104-borrowing-allows-smoothing-by-bringing-consumption-to-the-present) to revise the information about the borrowing, lending and consumption smoothing.  

It is possible to calculate the expected present value of future household income.  If we assume that people live for ever, this can be the present value of wealth. 

$$\Psi_t^E = (1 + r)A_{t - 1} + \sum_{i = 0}^\infty \frac{l}{(1 + r)^i} y_{t - i}^E$$

Where i is the post-tax lifetime labour income and A are the assets at the beginning of the process. 

Household consumption has to take account of the smoothing of consumption over periods when income may rise and fall due to expected and unexpected outcomes. The smoothing of consumption is based on the diminishing marginal utility of consumption. The Permanent Income Hypothesis (PIH) suggests that individuals optimally allocate their consumption over their lifetime. The resources used for this include assets and future income. This comes from Modigliani and Brmberg (1954) and Friedman (1957). There is a review of Frideman in Meghir (2004). Figure 1.7 shows how income and consumption change over the time in a simplified model. The government can also play a part in this process by providing benefits and social insurance. 

![Permanent Income Hypothesis](./Figures/Demand/lifecycle.jpg)

This model of consumption is different from the Keynesian version where the future is not explicitly considered. The question of whether individuals would like constant consumption or gradually rising or falling consumption will depend on the rate of interest and the rate at which individual trade assess the benefit of consumption now relative to consumption in the future. This is represented by $/rho$ which is a measure of impatience. The household chooses a part of consumption to maximise lifetime utility subject to the budget constraint. 
...
This is the annuity value of the expected lifetime wealth (derived in the appendix).  This remains constant unless expected wealth changes. 

The predictions of the PIH area that expected changes in income or wealth should have no major effect on consumption but unexpected changes should be important. The sensitivity of consumption to income will be a test of the theory. This is in contrast to the Keynesian consumption function. A temporary increase in income will have a modest effect because it will be spread over the entire future.  It will raise consumption by just $\frac{r}{1 + r}$ of the change.  If the interest rate is 4\%, the MPC is just 3.8\% and the multiplier in this case is just above 1. 
