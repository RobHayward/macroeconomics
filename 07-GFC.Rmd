...
However, the GFC showed the limits of monetary policy. The **zero-bound** suggests that it is difficult to reduce interest rates below zero and that reducing real interest rates is very difficult in times of deflation.  As a result, central banks tried new monetary methods such as: 
